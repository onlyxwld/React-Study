...
const SubscribePage = lazy(() => import("./components/SubscribeSection/Subscribe"))
      ...
      return (
        <Router history={history}>
            ...
            <Switch>
                ...
                <AppRoute path="/set-password:param" component={SetPassword} fullpage />
                ...
                <RequireAuth>
                    ...
                    <AppRoute path="/dashboard-calendar" component={Calendar} dashboard />
                    <AppRoute path="/dashboard-requests" component={Requests} dashboard />
                    <AppRoute path="/dashboard-presence" component={Presence} dashboard />
                    <AppRoute path="/dashboard-documents" component={Documents} dashboard />
