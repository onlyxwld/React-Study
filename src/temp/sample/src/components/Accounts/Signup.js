                                                ...
                                                <div className="col-12">
                                                    ...
                                                    <div className="form-group">
                                                        <div className="input-group">
                                                            ...
                                                            <input type="password" className="form-control" name="confirmpassword" placeholder="ConfirmPassword" onChange={(e) => this.setState({ confirmpassword : e.target.value})} required="required" />
                                                        </div>
                                                    </div>
