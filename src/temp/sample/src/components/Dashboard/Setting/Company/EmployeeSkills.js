        ...
        return (
            <>
                <Collapse defaultActiveKey={['1']}>
                    <Panel header="Habilidades de los empleados" key="1" extra={this.addPluseButton()}>
                        <Table columns={this.state.columns} rowKey={record => record._id} pagination={false} dataSource={this.state.dataSource} />
                    </Panel>
                </Collapse>
                <Modal title="Habilidades de los empleados" visible={this.state.isOpenModal} width={800} footer={""} onCancel={this.modalToggle}>
