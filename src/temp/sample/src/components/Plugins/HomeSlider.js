              ...
              <div
                ...
                <div className="slider__slide-content">
                  ...
                  <h2 className="slider__slide-heading">
                    {slide.description.split(' ').map((l, idx) => <span key={idx}>{l}&nbsp;</span>)}
                  </h2>
                  <div className="slider__slide-readmore">
                      <div>
                        <a className="play-btn" data-fancybox href={`uploads/slider/${this.props.video}`} style={{width : "70px", height : "70px"}}>
                ...
                <div className="slider__slide-parts">
                  {[...Array(this.IMAGE_PARTS).fill()].map((x, i) => (
                    <div className="slider__slide-part" key={i}>
                      <div className="slider__slide-part-inner" style={{ backgroundImage: `url(${slide.img_path})`}} />
                    </div>
                  ))}
                </div>
              </div>
