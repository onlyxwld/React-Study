...
class Coporate extends Component<CoporateProps, CoporateState> {
  state:CoporateState = {
              ...
              <div className="bulletin-board">
                ...
                <div className="bulletin-board-body">
                  <div className="no_message">
                    ...
                    <p>
                      Communicate with the company creating a{" "}
                      <span>new message</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="title">
                  ...
                  <Form>
                    <input
                      ...
                      style={{ height: "40px" }}
                      placeholder="Search by telecommuting, employee, position ..."
                    />
                  </Form>
                </div>
                <div className="body">
