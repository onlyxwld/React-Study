          ...
          <h3>
            ...
            {this.props.auth.authData
              ? this.props.auth.authData.first_name +
                " " +
                this.props.auth.authData.last_name
              : ""}
          </h3>
        </div>
        <Row>
          <Col md="6">
            <div className="profile-block dashboard-card">
              ...
              <div className="dashboard-card-body">
                ...
                <Row>
                  ...
                  <Col>
                    <h6>
                      <b>{this.state.months[new Date().getMonth()]}</b>
                    </h6>
                    <div className="d-flex flex-column text-center hour-content">
                      <span>
                        <b>0h</b>
            ...
            <div className="request-block dashboard-card">
              ...
              <div className="dashboard-card-body">
                ...
                <button className="btn btn-dashboard btn-primary">
                  New request
                </button>
              </div>
            </div>
              ...
              <div className="dashboard-card-body">
                <div className="event-card your-journey">
                  ...
                  <div className="event-card-body">
                    <h6 className="text-center p-1 mb-2">
                      <b>no business</b> 8h
                    </h6>
                    <div className="schedule">
                      <span>Schedule:</span>
                      <span>
                        <b>09:00:00 - 14:00:00</b>
                      </span>
                      <span>
                        <b>15:00:00 - 18:00:00</b>
                      </span>
                    </div>
                    <div className="center text-center py-2">
                      ...
                      <button className="btn btn-dashboard btn-primary m-auto w-50">
                        Get in
                      </button>
                    </div>
                  </div>
