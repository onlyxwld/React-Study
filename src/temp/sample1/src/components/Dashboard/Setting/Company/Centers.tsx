...
type CentersState = {
  ...
  timezone: string;
  centerIP: string;
  notTransferIP: boolean;
  notTransferLocation: boolean;
  latitude: number;
  longtitude: number;
  distance: number;
};

class Centers extends Component<CentersProps, CentersState> {
  state: CentersState = {
    isOpenModal: false,
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <Row className="mb-1">
              <Col className="d-flex align-items-center justify-content-between">
                ...
                <Switch
                  defaultChecked={this.state.isCenterIP}
                  onChange={this.onChangeIsCenterIP}
                />
              </Col>
            </Row>
            <Row>
              <Col>
                <FormGroup>
                  ...
                  <InputMask
                    ...
                    maskChar={null}
                    value={this.state.centerIP}
                    disabled={this.state.isCenterIP ? false : true}
                    className="ant-input"
                    onChange={this.onChangeCenterIP}
                    required
                  />
                  <Checkbox
                    onChange={this.onChangeNotTransferIP}
                    checked={this.state.notTransferIP}
                    disabled={this.state.isCenterIP ? false : true}
                  >
                    Bloquear fichajes fuera de estas IPs (separadas por comas)
                  </Checkbox>
                </FormGroup>
              </Col>
            </Row>
            <Row className="mb-1">
              <Col className="d-flex align-items-center justify-content-between">
                ...
                <Switch
                  defaultChecked={this.state.isLocation}
                  onChange={this.onChangeIsLocation}
                />
              </Col>
            </Row>
            <Row>
              <Col>
                <Space>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        this.setState({ latitude: Number(e.target.value) })
                      }
                      required
                      disabled={this.state.isLocation ? false : true}
                    />
                  </FormGroup>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        this.setState({ longtitude: Number(e.target.value) })
                      }
                      required
                      disabled={this.state.isLocation ? false : true}
                    />
                ...
                <Checkbox
                  onChange={this.onChangeNotTransferLocation}
                  checked={this.state.notTransferLocation}
                  disabled={this.state.isLocation ? false : true}
                >
                  Bloquear fichajes fuera de la ubicación
                </Checkbox>
              </Col>
            </Row>
