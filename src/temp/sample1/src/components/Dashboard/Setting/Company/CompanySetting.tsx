...
class Company extends Component<CompanyProps, CompanyState> {
  countryListOptions = countryList().getData();

  state: CompanyState = {
    edit: false,
    centersData: [{ value: "nobusiness", label: "nobusiness" }],
  ...
  editButton = () => (
    <>
      {this.state.edit ? (
        <Space>
          <Button
            onClick={(event) => this.editToggle(event)}
            type="default"
                ...
                <Col>
                  <FormGroup>
                    ...
                    <Input
                      type="text"
                      placeholder="C.C.C."
                      onChange={(e) => this.setState({ ccc: e.target.value })}
                      disabled={this.state.edit ? false : true}
                      required
                    />
                  </FormGroup>
