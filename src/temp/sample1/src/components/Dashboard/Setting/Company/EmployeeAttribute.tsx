...
class EmployeeAttribute extends Component<
  EmployeeAttributeProps,
  EmployeeAttributeState
> {
  state: EmployeeAttributeState = {
    isOpenModal: false,
    ...
    return (
      <>
        <Collapse defaultActiveKey={["1"]}>
          <Panel
            header="Atributos de los empleados"
            key="1"
        ...
        <Modal
          title="Atributos de los empleados"
