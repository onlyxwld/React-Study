...
class Agreements extends Component<AgreementsProps, AgreementsState> {
  ...
  handleSubmit = (e) => {
    ...
    var data = {
      ...
      originAgreements: this.state.originAgreements,
      dayType: this.state.dayType,
      yearEndDay: this.state.yearEndDay,
      yearHours: this.state.yearHours,
      nightHour: this.state.isNightWork ? this.state.nightHour : "",
    };
  ...
  render() {
    return (
      <>
        ...
        <Modal
          title="Convenios"
          visible={this.state.isOpenAgreementsModal}
          width={800}
          footer={""}
        ...
        >
          <Form onSubmit={this.handleSubmit}>
              ...
              <Col>
                <FormGroup>
                  ...
                  <Input
                    type="number"
                    name="name"
                    placeholder="Horas anuales por convenio"
                    onChange={(e) =>
                      this.setState({ yearHours: Number(e.target.value) })
                    }
                    required
                  />
                </FormGroup>
            ...
            <Row>
              <Col>
                <Radio.Group
                  onChange={this.onChangeNightWork}
                  className="d-flex flex-column"
                  value={this.state.isNightWork}
                >
                  <Radio value={true}>
                    Contabilizar las horas nocturnas de
                  </Radio>
              ...
              <Col>
                <RangePicker
                  ...
                  format="h:mm a"
                  value={[
                    moment(this.state.nightHour[0], "h:mm a"),
                    moment(this.state.nightHour[1], "h:mm a"),
                  ]}
                  onChange={this.onChangeNightHour}
                  disabled={this.state.isNightWork ? false : true}
                />
              </Col>
            </Row>
