...
class Calendar extends Component<CalendarProps, CalendarState> {
  countryListOptions = countryList().getData();
  ...
  addCalendar = () => (
    <Button
      onClick={(event) => this.calendarModalToggle(event)}
      type="primary"
  ...
  handleSubmitCanledar = (e) => {
    ...
    var data = {
      ...
      updateChecked: this.state.isChecked,
    };
    var isValidCode = postcodeValidator(
      this.state.zipCode,
  ...
  render() {
    return (
      <>
        ...
        <Modal
          title="Calendario"
          visible={this.state.isOpenCalendarModal}
          width={800}
          footer={""}
          onCancel={this.calendarModalToggle}
        >
          <Form onSubmit={this.handleSubmitCanledar}>
            ...
            <Row>
              <Col>
                <Checkbox onChange={this.isChecked}>
                  Sincronizar con calendario público. Se actualizará cada inicio
                  de año
                </Checkbox>
              </Col>
            </Row>
