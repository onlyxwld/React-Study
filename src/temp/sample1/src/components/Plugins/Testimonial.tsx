...
class Testimonial extends React.Component<TestimonialProps, TestimonialState> {
    ...
    testimonialData: [
      {
        ...
        content:
          "People are the most important asset of any company, and the most important asset for employees is their time. We aspire to a work environment that has no frictions.",
      },
      {
  ...
  render() {
    return (
      <section
        id="testim"
        className="testim ptb_100 container"
        style={{ backgroundColor: "#052b53", maxWidth: "100%" }}
      >
          ...
          <div className="row m-0">
            ...
            <div className="col-12 col-md-6">
              <div id="testim-content" className="cont">
                {this.state.testimonialData.length >= 1 ? (
                  this.state.testimonialData.map((item, idx) => {
                    return (
                ...
                {this.state.testimonialData.length >= 1 ? (
                  this.state.testimonialData.map((item, idx) => {
                    return (
                      <li
                        key={"dot_" + idx}
                        className={idx === 0 ? "dot active" : "dot"}
                      ></li>
                    );
                  })
                ) : (
